<div id="createxpense" class="modal" style="width: 350px;">
    <?php
    ...
    <div class="modal-content white">
        <span class="grey-text text-darken-4">New Expense</span> </br>
        <!--<span class="grey-text ultra-small">Field Marked with <span class="red-text">*</span> is required</span>-->
          <div class="row">
            <div class="input-field col s12">
                ...
                <label for="displayname" class="active">Expense Name <span class="red-text">*</span></label>
            </div>  
          </div>
    </div>
