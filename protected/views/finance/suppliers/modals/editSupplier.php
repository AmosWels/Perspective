        ...
        <!--<span class="grey-text ultra-small">Field Marked with <span class="red-text">*</span> is required</span>-->
                <div class="row">
                    <div class="input-field col s12">
                        <input placeholder="....." id="name" name="new-expense_name" type="text" required="required" value="<?php echo $record->names; ?>">
                        <label for="name" class="active">Supplier Name</label>
                    </div>  
                </div>
    </div>
    <div class="modal-footer">
        <!--<button type="#" class="modal-action waves-effect waves-blue btn grey ">Update</button>-->
